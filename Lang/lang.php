...
$allLangs = [
    'fr' => [
        ...
        'sousTitreIndex' => 'Organisez vos tournois plus rapidement, réduisez les erreurs de planning et offrez une expérience moderne aux coachs, bénévoles et familles.',
...
(Merci à Gontran pour la vidéo).',
        ...
        'indexCreationDePoules' => '⏱️ Gagnez plusieurs heures de préparation grâce à la création automatique des poules.',
        'indexPlanification' => '📅 Organisez toutes vos rencontres en quelques minutes grâce à une planification simple et intuitive.',
        'indexPlacementAutomatique' => '🤖 Laissez Brackito placer automatiquement les rencontres et évitez les erreurs de planning.',
        'indexSuivi' => '📲 Les coachs, joueurs et familles suivent les scores et classements en temps réel, sans vous solliciter.',
        'indexGestionDesAbsences' => '🔄 Réorganisez votre tournoi en quelques clics lorsqu\'une équipe est absente.',
        'indexInterfaceMobile' => '👥 Confiez facilement les scores aux bénévoles et arbitres depuis leur smartphone.',
        'indexGestionDesPartenaires' => '🤝 Offrez une meilleure visibilité à vos partenaires et sponsors pendant tout le tournoi.',
        'indexGestionCategories' => '🏆 Gérez toutes vos catégories (U9, U11, U13...) depuis une seule interface.',
        'indexTypePoule' => '✔️ Idéal pour les tournois en poules ou en aller-retour.',
...
'sousTitreIndex' => 'Organize your tournaments faster, reduce scheduling errors, and deliver a modern experience for coaches, volunteers, and families.',       
...
(Thanks to Gontran for the video).',
        ...
        'indexCreationDePoules' => '⏱️ Save hours of preparation with automatic pool generation.',
'indexPlanification' => '📅 Organize all your matches in minutes with intuitive scheduling.',
'indexPlacementAutomatique' => '🤖 Let Brackito automatically schedule matches and avoid planning mistakes.',
'indexSuivi' => '📲 Coaches, players and families follow scores and rankings live without asking organizers.',
'indexGestionDesAbsences' => '🔄 Easily reorganize your tournament when a team is absent.',
'indexInterfaceMobile' => '👥 Let volunteers and referees manage matches directly from their smartphones.',
'indexGestionDesPartenaires' => '🤝 Give your sponsors greater visibility throughout the tournament.',
'indexGestionCategories' => '🏆 Manage all age categories (U9, U11, U13...) from one intuitive interface.',
