...
class RencontreDAO {
    ...
    public function supprimerRencontresParPoule(int $idPoule): void {
        ...
        public function modifierRencontre(?int $idrencontre, ?int $equipeScore1 = null, ?int $equipeScore2 = null, ?int $terrain = null, ?string $heure = null, ?string $arbitre = null, ?int $tournoi_id = null) {
        ...
        private function decodePouleId($pouleId) {
            $parts = explode('-', $pouleId);
            return [
                'tournoi' => $parts[0],
                'categorie' => $parts[1],
                'numeroPoule' => intval($parts[2]),
            ];
        }
